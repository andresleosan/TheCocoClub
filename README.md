# The Coco Club — Luxury Nail Studio & Podology Clinic

Official web application for **The Coco Club** (Saint Helier, Jersey), featuring:
- **Haute-Couture Landing Page**: Built according to the brand guide (Khaki Green, Red Robin Terracotta, Jacobean Espresso, Oyster & Lace).
...
- **Package Manager**: **`pnpm`** (using `corepack pnpm`)
...
- **Address**: 14 La Motte Street, Saint Helier, Jersey JE2 4SY (Channel Islands)
- **Phone / WhatsApp**: `+44 7797 917296`
- **Instagram**: `@thecococlub.je`
