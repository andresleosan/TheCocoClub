...
import { Heart, CheckCircle2, Award, Coffee } from 'lucide-react';
...
export const AboutDeoana: React.FC<AboutProps> = ({ onOpenBooking }) => {
  const pillars = [
    {
      icon: Award,
      title: '30+ Years International Mastery',
    ...
    <section id="about" className="py-20 lg:py-28 bg-pearlBush/50 relative overflow-hidden border-y border-oyster-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-normal text-jacobean tracking-tight leading-tight uppercase">
            “You are not just another booking — this is your moment to be looked after.”
          </h2>
          <p className="text-sm sm:text-base text-jacobean/75 font-normal leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="relative mx-auto max-w-md">
              ...
              <div className="rounded-3xl overflow-hidden shadow-xl border-4 border-white aspect-[4/5] bg-oyster-200 relative">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-lace">
                  <p className="font-signature text-3xl text-gold-300">Deoana Moreno</p>
                  <p className="font-display text-xs text-lace uppercase tracking-widest font-normal">
              ...
              <div className="absolute -bottom-6 -right-4 sm:-right-6 bg-khaki text-white p-4 sm:p-5 rounded-2xl shadow-xl border-2 border-white max-w-[200px] text-center">
                <p className="font-display text-3xl sm:text-4xl font-normal">30+</p>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-3">
              <h3 className="font-display text-3xl sm:text-4xl font-normal text-jacobean uppercase tracking-tight">
                Expert Hands, Latin Heart
              </h3>
              <p className="text-sm sm:text-base text-jacobean/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-2">
              {pillars.map((pillar, idx) => {
                ...
                return (
                  <div key={idx} className="bg-white/90 rounded-2xl p-5 border border-oyster-200 shadow-xs hover:shadow-md transition-shadow">
                    <div className="w-10 h-10 rounded-xl bg-khaki-100/80 text-khaki-700 flex items-center justify-center mb-3">
                      <Icon className="w-5 h-5" />
                    </div>
                    <h4 className="font-display text-base sm:text-lg font-bold text-jacobean mb-1.5 uppercase tracking-wide">
                      {pillar.title}
                    </h4>
                    <p className="text-xs text-jacobean/70 leading-relaxed">
                      {pillar.description}
                    </p>
                  </div>
                );
            ...
            <div className="p-6 rounded-2xl bg-jacobean text-lace flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <p className="font-bodySerif italic text-base sm:text-lg text-oyster-100">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-full bg-redRobin hover:bg-redRobin-light text-lace text-xs font-bold uppercase tracking-wider whitespace-nowrap shadow-md transition-colors"
              >
                Book Your Visit
              </button>
            </div>
