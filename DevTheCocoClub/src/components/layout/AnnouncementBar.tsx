      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
        <div className="flex items-center gap-2 font-medium tracking-wide">
          ...
          <span className="text-lace/90">
            Private 1-on-1 Nail Atelier & Clinical Podology Sanctuary
          </span>
          <span className="hidden md:inline text-oyster-400">•</span>
          <span className="hidden md:inline text-oyster-300 font-light italic">
            Led by Deoana Moreno ({STUDIO_INFO.experienceYears} Years Mastery)
          </span>
        </div>

        <div className="flex items-center gap-4 text-oyster-200">
          <div className="flex items-center gap-1.5 hover:text-white transition-colors">
            <MapPin className="w-3.5 h-3.5 text-khaki-400" />
            <span>14 La Motte St, St Helier, Jersey</span>
          </div>
